...
var myRectangle = Rectangle(length: 200, width: 300)

let newRectangle = myRectangle.half()
print(newRectangle)
 ...
 */
var myOtherRectangle = Rectangle(length: 10, width: 5)
var mySmallerOtherRectangle = myOtherRectangle.half()
myOtherRectangle.halved()
print(myOtherRectangle)
print(mySmallerOtherRectangle)
