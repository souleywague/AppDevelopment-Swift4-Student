 ...
 */
var solo = User(name: "Solo", age: 27, height: 185, weight: 70, activityLevel: 6)

print("Hello, my name is \(solo.name) and I am \(solo.age). I weight \(solo.weight) and I am \(solo.height) tall. My current activity level is: \(solo.activityLevel).")
/*:
 ...
 */
let anotherMile = Distance(feet: 5249.344)
