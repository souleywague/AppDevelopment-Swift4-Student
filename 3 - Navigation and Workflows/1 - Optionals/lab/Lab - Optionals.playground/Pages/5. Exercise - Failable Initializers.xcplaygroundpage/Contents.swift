 ...
 */
let myLaptop = Computer(ram: 200, yearManufactured: 2016)
let anotherLaptop = Computer(ram: 150, yearManufactured: 2017)

if let unwarppedMyLaptop = myLaptop {
    print(unwarppedMyLaptop)
}

if let unwrappedAnotherLaptop = anotherLaptop {
    print(unwrappedAnotherLaptop)
}
