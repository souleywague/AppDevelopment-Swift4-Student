...
forwards(name1: "Amid", name2: "Zephir")
 ...
 */
var randomStringCollection = ["John", "Harry", "Tom", "Peter", "Jane"]

randomStringCollection.sorted(by: forwards)
/*:
 ...
 */
randomStringCollection.sorted { (firstName, secondName) -> Bool in
 ...
 */
let storedCollection3 = randomStringCollection.sorted { $0 < $1 }
print(storedCollection3)
