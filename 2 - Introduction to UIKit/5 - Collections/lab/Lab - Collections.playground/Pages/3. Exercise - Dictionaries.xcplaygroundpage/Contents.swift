...
numberOfDays = ["January": 31, "February": 28, "March": 31]
print(numberOfDays)
/*:
 ...
 */
if let myDate = numberOfDays["January"] {
    print("January has \(myDate) days.")
}
...
myDictionary = ["Shapes": shapesArray,
                "Colors": colorsArray]
print(myDictionary)
/*:
 ...
 */
if let colors = myDictionary["Colors"] {
    print(colors[2])
}
