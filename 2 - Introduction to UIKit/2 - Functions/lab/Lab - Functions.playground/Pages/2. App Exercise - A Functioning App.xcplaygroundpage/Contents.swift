...
func incrementSteps() {
    steps += 1
    print("Your total number of steps for today is \(steps).")
}
...
func progressUpdate() {
    switch steps {
    case 0...1000:
        print("Whooah! \(steps) steps? You're off to a good start.")
    case 1000...4999: print("Whooah! \(steps)steps? You're almost halfway there!")
    case 5000...8999: print("Whooah! \(steps) steps? You're over halfay there!")
    case 9000...9999: print("Whooah! \(steps) steps? You're almost there!")
    default: print("Whooah! \(steps) steps? You beat the goal!")
    }
}
