...
let favoriteBook = Book(title: "Anna Karenine", author: "Tolstoï", page: 1009, price: 10)
print("My favorite book is \(favoriteBook.title) from \(favoriteBook.author). It is \(favoriteBook.page) pages long and costs \(favoriteBook.price) euros.")
/*:
 ...
 */
var myHeight = Height(centimeters: 185)
print(myHeight)
