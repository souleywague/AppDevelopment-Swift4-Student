...
let todayRunning = RunningWorkout(distance: 3000, time: 20, elevation: 10)
print("Your average mile time is \(todayRunning.averageMileTime) meters per minute! Impressive!")
/*:
...
var todaySteps = Steps(steps: 9998, goal: 10000)
todaySteps.takeStep()
todaySteps.takeStep()
todaySteps.takeStep()
