...
let newRectangle = Rectangle(width: 6, height: 8)
...
struct Height {
    var heightInInches: Double {
        willSet {
            print("HeightInInches is about to change to \(newValue)")
        }
        didSet {
            if heightInInches != heightInCentimeters*2.54 {
                print("heightInCentimeters should be \(heightInInches*2.54)")
            }
        }
    }
    ...
    var heightInCentimeters: Double {
        willSet {
            print("HeighInCentimeters is about to change to \(newValue)")
        }
        didSet {
            if heightInCentimeters != heightInInches/2.54 {
                print("heightInInches should be \(heightInCentimeters/2.54)")
            }
        }
    }
...
var myHeight = Height(heightInInches: 34)
print(myHeight)
myHeight.heightInInches = 35
print(myHeight)
myHeight.heightInCentimeters = 88.9
print(myHeight)
